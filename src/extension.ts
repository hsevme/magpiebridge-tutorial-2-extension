...
export function activate(context: ExtensionContext) {
  ...
  let args = [
    "-jar",
    context.asAbsolutePath("cpachecker-language-server-poc-0.0.1-SNAPSHOT.jar"),
    context.asAbsolutePath("preparedResults.json"),
  ];
  ...
  let lc: LanguageClient = new LanguageClient(
    "Tutorial2",
    "Tutorial2",
    serverOptions,
    clientOptions
